...
q = 1;
C = 47e-9;
m = 4.68; % posé pour avoir un C qui est dans notre kit 

% Calculs des valeurs
R = sqrt(cste_s2/(C^2 * m * q)); % donne environ 115k
...
% calculs des valeurs
R2 = sqrt(numerateur)/C2; % donne environ 15.3
q2 = cste2_s/(R*C*2);
m2 = cste2_s2/(q*R^2 * C^2 );
